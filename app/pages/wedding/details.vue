<template>
  <div class="p-4">
    ...
    <BaseDialog v-model:is-show-dialog="isDialogVisible" :title="$t('Invite new member')">
      <form @submit.prevent="createInviteMember">
        ...
        <div class="flex justify-end">
          <BaseButton :name="$t('Submit')" type="btn-primary" :is-loading="isLoading('create')" />
        </div>
      </form>
    </BaseDialog>
  </div>
